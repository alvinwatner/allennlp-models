...
#         print("")
#         print("")
#         span_start = td['span_start'].sequence_index
#         span_end  = td['span_end'].sequence_index
#         print(f"span_start = {span_start}")
#         print(f"span_end = {span_end}")
#         print(td['passage'][span_start])
#         print(td['passage'][span_end])
#         print(td['passage'][span_start:span_end + 1])
#         print("="*100)
#         print("")
#         print("")
#         print("Input is down below here:")
#         inp = [*td['passage'], *td['passage'][span_start:span_end + 1]]
#         token_indexers: Dict[str, TokenIndexer] = {"tokens": SingleIdTokenIndexer()}
#         inp = TextField(inp, token_indexers=token_indexers)
#         print(inp)
        break
    else:
        counter += 1
